...
Explorer:
http://explorer.traaittPlatform.com

Mining Pool:
http://mining.traaittPlatform.com


# Installing

We offer binary images of the latest releases here: http://latest.traaittPlatform.com


# Graphical User Interface Wallet
How to properly use traaittPlatform Cryptocurrency on Apple, Windows or Linux Machines.

traaittPlatform Proton is a Wallet with built in Server communication and local stored transaction history.
It is really easy to use.

You can always find the newest Release here: https://github.com/traaittPlatform/traaittPlatform


# Command Line Interface Wallet
How to properly use traaittPlatform Cryptocurrency on Apple, Windows or Linux Machines.

1st step: synchronize traaittPlatform
```
...
- `git clone -b master --single-branch https://github.com/traaittPlatform/traaittPlatform-lmdb`
- `cd traaittPlatform-lmdb`
- `mkdir build`
- `cd build`
- `cmake ..`
- `make`
...
# Copyright Section
```
// Copyright (c) 2020-TODAY traaittPlatform
